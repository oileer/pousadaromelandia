...
const quartos = [
  {
    ...
    amenidades: ["Ar-condicionado", "Wi-Fi", "TV", "Banheiro Privativo"],
    waMsg: "Olá! Tenho interesse no Quarto Família (Quarto 5). Poderia verificar a disponibilidade?",
    destaque: true,
  },
  {
    id: "q6",
    ...
    amenidades: ["Ar-condicionado", "Wi-Fi", "TV", "Banheiro Privativo"],
    waMsg: "Olá! Tenho interesse no Quarto Superior (Quarto 6). Poderia verificar a disponibilidade?",
    destaque: false,
  },
  {
    id: "q7",
    ...
    amenidades: ["Ar-condicionado", "Wi-Fi", "TV", "Banheiro Privativo"],
    waMsg: "Olá! Tenho interesse no Quarto Conforto (Quarto 7). Poderia verificar a disponibilidade?",
    destaque: false,
  },
  {
    id: "q8",
    ...
    amenidades: ["Ar-condicionado", "Wi-Fi", "TV", "Banheiro Privativo"],
    waMsg: "Olá! Tenho interesse no Quarto Casal (Quarto 8). Poderia verificar a disponibilidade?",
    destaque: false,
  },
  {
    id: "q9",
    ...
    amenidades: ["Ar-condicionado", "Wi-Fi", "TV", "Banheiro Privativo"],
    waMsg: "Olá! Tenho interesse no Quarto Triplo (Quarto 9). Poderia verificar a disponibilidade?",
    destaque: false,
  },
]

...
const reviews = [
  { name: "Rodrigo M.",   photo: "/assets/Clientes/1.jpg",  text: "Ã“tima pousada! Quarto limpo, wi-fi funcionando bem e atendimento excelente. Recomendo para quem precisa ficar em RomelÃ¢ndia." },
  { name: "Mariana S.",   photo: "/assets/Clientes/2.jpg",  text: "Muito aconchegante e bem localizado. O pessoal Ã© super atencioso. Com certeza voltarei!" },
  { name: "Carlos A.",    photo: "/assets/Clientes/3.jpg",  text: "Melhor custo-benefÃ­cio da regiÃ£o. Limpo, silencioso e com tudo que precisava para uma boa noite de descanso." },
  { name: "Ana Paula F.", photo: null, text: "Atendimento impecÃ¡vel desde a reserva atÃ© o checkout. CafÃ© da manhÃ£ farto e quarto muito confortÃ¡vel." },
  { name: "FÃ¡bio L.",     photo: null, text: "Passei 3 noites a trabalho e foi excelente. Wi-Fi estÃ¡vel, silencioso e localizaÃ§Ã£o perfeita no centro." },
]

function Stars() {
  return (
    <div style={{ display: "flex", gap: 3, marginBottom: 16 }}>
      {[1,2,3,4,5].map(i => <span key={i} style={{ color: "#C8A97A", fontSize: ".9rem" }}>â˜…</span>)}
    </div>
  )
}
  ...
  return (
    ...
    >
      ...
      <p style={{
        ...
        fontSize: "1.08rem", lineHeight: 1.65, color: "rgba(250,247,242,.85)", marginBottom: 24,
      }}>
        &ldquo;{text}&rdquo;
      </p>
...
export default function TestimonialsSection() {
  return (
    <section className="testimonials-section-pad" style={{ background: "#1F1B16", padding: "96px 40px" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <div className="reveal" style={{ marginBottom: 56 }}>
          ...
          <h2 style={{ fontFamily: "var(--font-cormorant)", fontSize: "clamp(2rem, 3.5vw, 3rem)", fontWeight: 300, color: "#FAF7F2", lineHeight: 1.15 }}>
            O que nossos <em style={{ fontStyle: "italic" }}>hÃ³spedes dizem</em>
          </h2>
        </div>

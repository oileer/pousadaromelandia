...
export default function AboutSection() {
  return (
    <section className="about-section-pad" style={{ background: "#F0EAE0", padding: "96px 40px" }}>
      <div className="about-grid">
        {/* Images composition */}
        <div className="reveal about-images-wrap">
          {/* Main image */}
          <div style={{
            ...
            <Image src="/assets/Corredores/0.jpeg" alt="Entrada da Pousada RomelÃ¢ndia" fill style={{ objectFit: "cover" }} sizes="(max-width: 768px) 100vw, 50vw" />
          </div>
          ...
          <div style={{
            ...
            <Image src="/assets/Quarto5/1.jpeg" alt="Quarto Pousada RomelÃ¢ndia" fill style={{ objectFit: "cover" }} sizes="(max-width: 768px) 100vw, 30vw" />
          </div>
          ...
          <div style={{
            ...
            padding: "14px 18px", textAlign: "center" as const, borderRadius: 2,
        ...
        <div className="reveal">
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 28 }}>
            ...
            <span style={{ color: "#C8A97A", fontSize: ".6rem" }}>âœ¦</span>
            <div style={{ width: 40, height: 1, background: "#C8A97A" }} />
          </div>

          <h2 style={{
            fontFamily: "var(--font-cormorant)", fontSize: "clamp(1.8rem, 2.8vw, 2.6rem)",
          ...
          <p style={{ fontFamily: "var(--font-lato)", fontSize: ".93rem", color: "rgba(31,27,22,.68)", lineHeight: 1.75, marginBottom: 14 }}>
            Desde 2018 no centro de RomelÃ¢ndia SC, oferecemos acomodaÃ§Ãµes confortÃ¡veis e atendimento personalizado para viajantes a negÃ³cios ou lazer.
          </p>
          <p style={{ fontFamily: "var(--font-lato)", fontSize: ".93rem", color: "rgba(31,27,22,.68)", lineHeight: 1.75 }}>
            SÃ£o 9 quartos cuidadosamente equipados â€” com ar-condicionado, Wi-Fi de alta velocidade, TV e roupa de cama de qualidade.
          </p>

          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px 20px", margin: "24px 0 32px" }}>
            {["Wi-Fi gratuito", "Ar-condicionado", "Estacionamento", "CafÃ© da manhÃ£", "Atendimento 24h", "LocalizaÃ§Ã£o central"].map(item => (
